        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-lg md:gap-xl mt-xl">
          <div className="bg-glass-surface backdrop-blur-[20px] border border-glass-border rounded-lg p-lg md:p-xl shadow-glass flex flex-col gap-lg">
            <div className="flex items-start gap-md">
              ...
              <div><h3 className="text-[1.1rem] text-primary mb-xs font-semibold">Email</h3><p className="text-secondary text-[0.95rem]">{c.email}</p></div>
            </div>
            <div className="flex items-start gap-md">
              <Phone size={24} className="text-accent-purple shrink-0 mt-[2px]" />
              <div><h3 className="text-[1.1rem] text-primary mb-xs font-semibold">Phone</h3><p className="text-secondary text-[0.95rem]">{c.phone}</p></div>
            </div>
            <div className="flex items-start gap-md">
              <MapPin size={24} className="text-accent-purple shrink-0 mt-[2px]" />
              <div><h3 className="text-[1.1rem] text-primary mb-xs font-semibold">Location</h3><p className="text-secondary text-[0.95rem]">{c.location}</p></div>
            </div>
            <div className="flex items-start gap-md">
              <Clock size={24} className="text-accent-purple shrink-0 mt-[2px]" />
              <div><h3 className="text-[1.1rem] text-primary mb-xs font-semibold">Support Hours</h3><p className="text-secondary text-[0.95rem]">{c.hours}</p></div>
            </div>
          </div>
          <div className="bg-glass-surface backdrop-blur-[20px] border border-glass-border rounded-lg p-lg md:p-xl shadow-glass">
            ...
            {[[c.faq1Q, c.faq1A], [c.faq2Q, c.faq2A], [c.faq3Q, c.faq3A]].map(([q, a], i) => (
              <div key={i} className="mb-lg pb-lg border-b border-glass-border last:border-b-0 last:mb-0 last:pb-0">
                <h3 className="text-[1rem] text-primary mb-sm font-semibold">{q}</h3>
                <p className="text-secondary leading-[1.6] text-[0.95rem]">{a}</p>
              </div>
            ))}
          </div>
        </div>
